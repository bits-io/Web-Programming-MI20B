...
<html lang="en">
        ...
        <div class="login-container d-flex flex-center flex-row flex-row-fluid order-2 order-lg-1 flex-row-fluid bg-white py-lg-0 pb-lg-0 pt-15 pb-12">
          ...
          <!--   ============== PANGGIL KONTEN ============ -->
            ...
            <div class="login-form">
              <!--begin::Form-->
              <!-- <form class="form px-10" method="post" action=""> -->
                ...
                <div class="" data-wizard-type="step-content" data-wizard-state="current">
                  ...
                  <form method="post" action="<?php echo $ctrl->simpanVaksin();?>">
                    ...
                    <div class="form-group row">
                          <div class="col-lg-12 mb-4">
                           ...
                           <input autocomplete="off" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6"  name="alamat" id="alamat" placeholder="Alamat" oninput="this.value = this.value.toUpperCase()" >
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-12 mb-4 ">
                      <label for="status_vaksin" class="font-size-h6 font-weight-bolder text-dark">Sudah Vaksin?</label>
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <form method="post" action="#" id="formPskms" name="form1">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Tambah Puskesmas</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                  </div>
                                  <div class="modal-body">
                                    <input type="text" autocomplete="off" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6"  name="optpuskesmas" id="optpuskesmas" placeholder="Puskesmas" oninput="this.value = this.value.toUpperCase()" >
                                  </div>
  ...
  <!--end::Body-->
    ...
    <script type="text/javascript">
        ...
        function show_puskesmas(){ //untuk menampilkan data puskesmas
          $.ajax({
            ...
            success : function(data) {
              ...
              var i;
              var no;
              html += '<option value="none">-- Pilih Puskesmas --</option>';
        ...
        function show_status(){ //untuk menampilkan data puskesmas
          $.ajax({
            ...
            success : function(data) {
              ...
              var i;
              var no;
              html += '<option value="none">-- Status --</option>';
              for(i=0; i<data.length; i++){
                no = i + 1;
      ...
      tambah_puskms();
      function tambah_puskms() {
            $('#formPskms').on('submit', function(e) {
                e.preventDefault();
                let optpuskesmas = $('#optpuskesmas').val();
                console.log("wokkkk");
                console.log(optpuskesmas);
                $.ajax({
                    url: 'api_puskesmas.php',
                    type: 'POST',
                    data: {
                      optpuskesmas: optpuskesmas,
                    },
                    dataType: 'json',
                    success: function(data) {
                        show_puskesmas();
